  ...
  try {
    ...
    request.onreadystatechange = function() {
      if(this.readyState === 4 && this.status === 200) {
        window.localpath=this.responseText;
      }
      document.getElementById("localpath").innerHTML=localpath;
    }
    request.send();
  } catch {
    window.localpath="/home/httpd/html/cgi-bin";
  }
}
    ...
    request.onreadystatechange = function() {
        ...
        if(this.readyState === 4 && this.status === 200) {
            ...
            if(display.LED_Light) {
              document.getElementById("LED_LightBtn").innerHTML = '<img id="LightBtn" class="" src="/static/icons/led_on.png" alt="LED_Light">'
            }
            else {
              document.getElementById("LED_LightBtn").innerHTML = '<img id="LightBtn" class="" src="/static/icons/led_off.png" alt="LED_Light">'
            }
